...
# Wir teilen die Zeichenkette anhand von Zeilenumbrüchen in eine Liste von Dateipfaden
changed_files = changed_files_str.strip().split('\n')

for file_path in changed_files:
    if not file_path:  # Überspringe leere Zeilen
        continue
...
# Die URL für die Gemini API --- HIER IST DIE ÄNDERUNG ---
