...
if not pr_body:
    ...
    # Wir geben einen leeren String aus, damit der Workflow nicht fehlschlägt.
    # ::set_output ist veraltet, GITHUB_OUTPUT ist der neue Weg.
    with open(os.environ['GITHUB_OUTPUT'], 'a') as fh:
       print(f'corrected_text=', file=fh)
    sys.exit(0)
